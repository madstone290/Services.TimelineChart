...
namespace Services.TimelineChart.Samples.MultiMesSample {
    const legendData = {
        leftLegendItems: [
    ...
    const machinePointEventRender = function (event: any, canvasElement: HTMLElement, containerElement: HTMLElement) {
        const imgElement = document.createElement("img");
        imgElement.style.width = "100%";
        imgElement.style.height = "100%";
...
window.addEventListener("load", () => {
    Services.TimelineChart.Samples.MultiMesSample.load();
});
